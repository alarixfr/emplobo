...
const THEMES: Record<string, GridTheme> = {
  ...
  light: {
    bg: "#ffffff",
    lineBase: { r: 20, g: 66, b: 37, a: 0.14 },
    nodeBase: { r: 20, g: 66, b: 37, a: 0.24 },
    dotTexture: "rgba(20,66,37,0.07)",
    lineActive: { r: 20, g: 66, b: 37, a: 0.85 },
    nodeActive: { r: 20, g: 66, b: 37, a: 1.0 },
    glow: "20,66,37",
    ripple: "20,66,37",
  },
};
...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      ctx.fillStyle = theme.dotTexture;
