        ...
        sections={[
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Semua panggilan AI (training, penilaian kesiapan, penyusunan guide, dan tutor) diproses melalui proxy AI Hack Club dengan model OpenAI gpt-oss-safeguard-20b sebagai penyedia model pihak ketiga. Teks Anda selalu dibungkus sebagai data, bukan instruksi, sebelum dikirim.",
