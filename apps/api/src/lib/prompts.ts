...
const LANGUAGE_DIRECTIVE = [
  "BAHASA: Selalu menjawab dalam Bahasa Indonesia yang jelas, hangat, dan mudah dimengerti oleh pemilik usaha maupun karyawan UMKM.",
...
export function buildGuideSystemPrompt(
  ...
  return [
    ...
    "",
    "STRUKTUR PANDUAN:",
    "- Buat 2–5 bab. Tiap bab berjudul padat dan berisi Markdown yang rapi (langkah bernomor, bullet, dan tabel bila relevan). Target pembaca: karyawan baru yang ingin langsung praktik.",
    ...
    "- Jaga agar setiap bab ringkas namun lengkap (±150–250 kata) supaya seluruh JSON muat dalam batas output.",
    "",
    INJECTION_DEFENSE,
    "",
